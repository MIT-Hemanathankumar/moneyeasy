...
import '../plan_choose/plan_choose_widget.dart';
                      ...
                      child: Row(
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(45, 0, 5, 0),
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => PlanChooseWidget(),
                                    ),
                                  );
                                },
                                text: 'Create Account',
                  ...
                  await Navigator.push(
                    ...
                    PageTransition(
                      ...
                      child: FlutterFlowExpandedImageView(
                        image: Image.network(
                          'http://3.7.102.61/moneyeasy-adminpanel-local/media/logos/money_easy_logo.png',
                          fit: BoxFit.contain,
                        ),
                        allowRotation: false,
                        tag: 'imageTag2',
